...
func (r *ProductDeploymentPipelineScheduler) searchForTargetsInNamespace(ctx context.Context, selector v1.LabelSelector, namespace string) (*v1alpha1.TargetList, error) {
