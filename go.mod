...
require (
	...
	github.com/open-component-model/git-controller v0.10.2-0.20231207113955-1579d546c28e
	...
	github.com/open-component-model/replication-controller v0.12.2-0.20231207113932-3c647250142a
